...
INSERT INTO DAILY_NOBLE_DATA  (
    ...
    FROM
        STAGING_NOBLE
    WHERE
        CONTACT_DATE = TO_DATE(SYSDATE - DATE_GAP, 'DD-MON-YY'));
...
USING (SELECT DISTINCT AGENT_NAME AS AGENTS,CODE FROM DAILY_NOBLE_DATA DND WHERE DND.CONTACT_DATE = TO_DATE(SYSDATE - DATE_GAP, 'DD-MON-YY'))
